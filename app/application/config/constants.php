...
defined('MQTT_USER') OR define('MQTT_USER', 'r7UHh6B9daiZB6c');
defined('MQTT_PASSWORD') OR define('MQTT_PASSWORD', 'yqe1yU74qY0wKAL');
defined('ROOT_TOPIC') OR define('ROOT_TOPIC', 'SCl0PwQZyTXBKu0');
