          ...
          <form class="" action="<?php echo base_url('register/doregister')?>" method="post">
            ...
            <div class="mdl-grid">
              <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                <span class="mdl-card__title-text text-color--smooth-gray">Invernadero IoT</span>
              </div>
              <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
              ...
              <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                  ...
                  <label class="mdl-textfield__label" for="password">Repetir contraseña</label>
                </div>
                ...
                <span class="login-link">Yo acepto los <a href="#" class="underlined">terminos de servicio</a></span>
              </div>
              <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone submit-cell">
                <a href="<?php echo base_url('login')?>" class="login-link">Ya me registré</a>
