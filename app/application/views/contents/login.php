                  ...
                  <form class="" action="<?php echo base_url('login/dologin')?>" method="post">
                    ...
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                            ...
                            <span class="login-secondary-text text-color--smoke">Rellene los campos para ingresar</span>
                        </div>
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                        ...
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone submit-cell">
                            <a href="<?php echo base_url('register')?>" class="login-link">Registrarse</a>
