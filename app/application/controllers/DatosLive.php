...
class DatosLive extends CI_Controller {
  ...
  public function index()
  {
		...
		$data['user_device'] = $_SESSION['selected_device'];
    ...
    $this->load->view('contents/datosLive',$data); //el main entre otra cosas necesitará los datos para graficar históricos.
