...
$(document).ready(function(){
		...
		window.location.replace("https://arduinointerfaz.000webhostapp.com/app/");//Redirecciona al cargar el documento
});
</script>
	  ...
	  OneSignal.push(function() {
	    OneSignal.init({
	      appId: "bdc5c0a8-4e12-4ed8-ba32-ca4263a610e3",
			...
			//OneSignal.setEmail("ivan083198@hotmail.com");
	  });
	</script>
...
<table id='Tabla' class='table' style='font-size: 30px;'>
	<thead>
		<tr>
		<th colspan=\"4\"> Mediciones en tiempo real</th>
		</tr>
	</thead>
